...
<div style="display: flex; gap: 10px; align-items: flex-start;">
  ...
  <div style="flex: 2; max-width: 66%;">
    <video controls width="100%" height="auto">
      <source src="https://birds-project.com/open-source/video/birds_bus_opensource_webinar_27.mp4" type="video/mp4">
  ...
  <div style="flex: 1; max-width: 33%;">
    <object 
      data="https://birds-project.com/open-source/pdf/BIRDS_BUS_Opensource_27_chat.pdf" 
      width="100%" 
      height="275px">
      <p>Your browser does not support PDFs. <a href="https://birds-project.com/open-source/pdf/BIRDS_BUS_Opensource_27_chat.pdf">Download the PDF</a>.</p>
    </object>
  </div>
</div>

<!-- Download Presentation  -->
[<img src="https://raw.githubusercontent.com/FortAwesome/Font-Awesome/6.x/svgs/regular/circle-down.svg" width="15" height="15"> Webinar #26 presentation (BIRDS Open Source Updates & Research Insights) Jun 11, 2025](https://birds-project.com/open-source/pdf/BIRDS_BUS_OpensourceWebinar_27_Husseinat.pdf){: .btn .btn-outline .text-grey-lt-000}
...
[Previous]({{site.url}}//resources/webinars/webinar-26){: .btn .btn-purple }
[Next]({{site.url}}/resources/webinars/webinar-28){: .btn}
